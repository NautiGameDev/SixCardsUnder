...
{
    public class Frost : Ability
    {
        public Frost(Projectile.ProjSource projSource) : base(projSource)
        {
            sprite.SetImage("Assets/Abilities/Ability_Frost.png");
        ...
        public override void Cast(Dungeon dungeonReference, Vector2 position, float projectileRotation)
        {
            ...
            Projectile newProjectile = new Projectile(
                ...
                projectileRotation,
                dungeonReference,
                "Assets/Audio/psychicHit.wav");

            newProjectile.sprite.SetImage("Assets/Abilities/Ability_Frost.png");
            newProjectile.sprite.SetDimensions(new Vector2(256, 256));
            newProjectile.sprite.SetScale(new Vector2(1f, 1f));
            newProjectile.sprite.SetShadow("Assets/Abilities/Ability_Frost_Shadow.png");
            ...
            AudioController.PlaySound("Assets/Audio/psychic.wav", effectsVolume, false);
        }
    }
}
