...
namespace PixelArtGameJam.Game.Abilities
{
    ...
    {
        public Bolt(Projectile.ProjSource projSource) : base(projSource)
        {
            sprite.SetImage("Assets/Abilities/Ability_Bolt.png");
        ...
        public override void Cast(Dungeon dungeonReference, Vector2 position, float projectileRotation)
        {
            ...
            newProjectile.sprite.SetImage("Assets/Abilities/Ability_Bolt.png");
            newProjectile.sprite.SetDimensions(new Vector2(256, 256));
            newProjectile.sprite.SetScale(new Vector2(1f, 1f));
            newProjectile.sprite.SetShadow("Assets/Abilities/Ability_Bolt_Shadow.png");
